      ...
      jobs: [
        {
          ...
          org: "Purdue University Libraries (PURR)",
          location: "West Lafayette, IN",
          salary: "$62,000–86,100",
          url: "https://jobs.code4lib.org/jobs/64447-research-data-curation-specialist",
          originalUrl: "https://careers.purdue.edu/job/Research-Data-Curation-Specialist/36201-en_US/",
          snippet:
            "Review datasets, code, documentation, and related materials for publication with attention to FAIR principles, best practices, long-term sustainability, and compliance with policies, security, and ethical standards… metadata management and enrichment, workflow development, analysis of repository metrics.",
        },
        {
          title: "Electronic Resources Librarian",
          org: "Seton Hall University Libraries",
          location: "South Orange, NJ",
          salary: "$61,767–68,630",
          url: "https://jobs.code4lib.org/jobs/65119-electronic-resources-librarian",
          originalUrl: "https://jobs.shu.edu/cw/en-us/job/496966/electronic-resources-librarian",
          snippet:
            "Manage and curate electronic resource holdings, analyze usage data, and create annual usage statistics using COUNTER-compliant standards… experience with MarcEdit, OpenRefine, and/or Python; experience with Tableau or PowerBI.",
        },
      ],
    },
    {
