...
<div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
  ...
  <a
    href="/teaching/lis4220/schema-formats/markdown"
  ...
  >
    ...
    <p class="text-sm text-gray-600 dark:text-gray-400">
      Learn Markdown syntax with a live editor, quick reference, and a plain-text-to-Markdown conversion exercise.
    </p>
  </a>
</div>
