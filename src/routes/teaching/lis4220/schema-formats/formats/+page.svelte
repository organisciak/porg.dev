...
<section class="prose prose-gray max-w-none dark:prose-invert">
  ...
  <p>
    ...
    the <em>container</em>; the content and expectations are separate. Similarly, JSON and XML are
    formats for data, while schema.org is a schema that tells you what to put inside.
  </p>
</section>
